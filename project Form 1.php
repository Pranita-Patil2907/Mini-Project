...
<head>
    ...
    <link rel="stylesheet" href="project Form 1.css">
</head>
<body>
    ...
    <nav class="nav-bar">
        ...
        <div class="nav-pages">
            ...
            <div class="nav-box1 border">
                <a href="index.html" target="_blank"> Home </a>
            </div>
    
            <div class="nav-box2 border">
                <a href="Dining.html" target="_blank" > Dinning </a>
            </div>
    
            <div class="nav-box3 border">
                <a href=""> Rooms </a>
            </div>
        ...
        <div class="btn">
            <button class="btn-stay"> BOOK A STAY</button>
        </div>
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    if(!$result){
        ...
        echo '<div class="alert alert-success" role="alert">
         Your data has been recorded successfully  </div> '; 
        }
    ...
    <div class="container">
        <div class="contactinfo">
            <div class="box">
                ...
                <div class="text">
                    <h3>Address:</h3>
                    <p>Kolhapur-Hupari Rd Snagavade,<br>Maharashtra <br>410202</p>
                </div>
            </div>
    ...
    <div class="contactform">
        ...
        <form action="project Form 1.php" method="POST">
            <h2>Send Message</h2>
            <div class="inputbox">
